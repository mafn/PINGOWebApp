class OrderOption
  ...
  field :votes, type: String, default: "" #Actually we'd like to have an array of
  # integers here, where every entry stands for the votes for this option at this
  # (entry's) postion. But since there's is no Mongoid field type "IntegerArray",
  # we do it via a String, e.g. "5,8,0,0,5,3"
